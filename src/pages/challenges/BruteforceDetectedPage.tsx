...
function BruteforceDetectedPage() {
    ...
    if (allQuestionsAnswered && correctAnswersCount === totalQuestions) {
      if (profile) {
        try {
          ...
          // Set XP amount for intermediate difficulty
          const xpAmount = 200;
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-lg p-8 z-50 text-center relative shadow-2xl max-w-md w-full">
              ...
              <div className="flex justify-center space-x-4">
                <a
                  href="https://www.linkedin.com/sharing/share-offsite/?url=https://forensix.net/challenge/bruteforce-detected"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://twitter.com/intent/tweet?text=I%20just%20finished%20the%20Bruteforce%20Detected%20challenge%20on%20ForensiX!"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-4 py-2 bg-white text-blue-600 rounded hover:bg-gray-100 font-semibold"
                >
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <p className="text-red-500 hover:text-red-400 font-semibold">PacketSniffer42</p>
                  </div>
                </div>
              </div>
            </div>
...
export default BruteforceDetectedPage;